...
if (!isset($_SESSION['user_id'])) {
    ...
    header('Location: /cardapio-dinamico-semapi/login.php');
    exit();
}
...
<body>
    <header>
        <h1>Pagamento Em Pix </h1>
    </header>

    <main>
    <div class="banner">
    <h2>Conclua seu pagamento com facilidade!</h2>
    <p>Seu pedido foi registrado com sucesso. Para finalizar o pagamento via PIX, procure o caixa, um atendente ou aguarde o entregador.</p>
    <p><strong>Valor Total:</strong> R$ <?php echo number_format($valor_total, 2, ',', '.'); ?></p>
</div>

        <!-- Botão para voltar à página inicial -->
        <div class="btn-container">
            <a href="/cardapio-dinamico-semapi/index.php" class="btn-voltar">Voltar para a Página Inicial</a>
        </div>
    </main>
