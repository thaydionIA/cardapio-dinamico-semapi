...
<head>
    ...
    <title>Login</title>
    <link rel="stylesheet" href="/cardapio-dinamico-semapi/assets/css/login.css?v=<?php echo time(); ?>">
</head>
<body>
...
<main>
    <div class="login-container">
        ...
        <form action="login.php" method="POST" class="login-form">
            ...
            <p class="no-account">Não tem uma conta? <a href="/cardapio-dinamico-semapi/cadastro.php">Cadastre-se</a></p>

            <!-- Link para a página de recuperação de senha -->
            <p class="forgot-password"><a href="/cardapio-dinamico-semapi/esqueceu_senha.php">Esqueceu a senha?</a></p>
        </form>
    </div>
</main>
