...
<head>
    ...
    <link rel="stylesheet" href="/cardapio-dinamicoS/assets/css/style.css"> <!-- Incluindo seu CSS principal -->
...
<div style="display: flex; align-items: center; position: relative; width: 100%;">
    <img src="/cardapio-dinamicoS/path/logo.jpg" alt="Logo do Site" style="height: 60px; margin-right: 15px;">
